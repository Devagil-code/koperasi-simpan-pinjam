...
(function () {
    ...
    (i = function () {
        ...
        return t.prototype.set_default_values = function () {
            ...
            var e, s;
            return (t.search_match || t.group_match) && t.active_options > 0 ? ((e = []).push("group-result"), t.classes && e.push(t.classes), s = document.createElement("li"), s.className = e.join(" "), s.innerHTML = t.highlighted_html || t.label, t.title && (s.title = t.title), this.outerHTML(s)) : ""
            ...
            var e, s;
            return s = this.search_contains ? t : "\\b" + t + "\\w*\\b", this.enable_split_word_search || this.search_contains || (s = "^" + s), e = this.case_sensitive_search ? "" : "i", new RegExp(s, e)
        ...
        return r(n, e), n.prototype.setup = function () {
            ...
            if (this.is_multiple) {
                for (o = {
                        ...
                        display: "none",
                        whiteSpace: "pre"
                    }, i = 0, n = (h = ["fontSize", "fontStyle", "fontWeight", "fontFamily", "lineHeight", "textTransform", "letterSpacing"]).length; i < n; i++) o[r = h[i]] = this.search_field.css(r);
                return (s = t("<div />").css(o)).text(this.get_search_field_value()), t("body").append(s), l = s.width() + 25, s.remove(), e = this.container.outerWidth(), l = Math.min(e - 10, l), this.search_field.width(l)
            }
