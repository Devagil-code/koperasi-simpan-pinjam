...
<script>
    $(document).ready(function(){
        var oTable = $('#datatable-buttons').DataTable({
                        processing: true,
                        serverSide: true,
                        ajax: "{{ route('transaksi-simpanan.index') }}",
                        columns: [
                            {data: 'id', name: 'id'},
                            {data: 'tgl', name: 'tgl'},
                    ...
                    $("div.toolbar").html('<a href="{{ route('transaksi-simpanan.create') }}" class="btn btn-gradient btn-rounded waves-light waves-effect w-md">Tambah Simpanan</a>');
